 ...
 */
 ...
 (function($) {
    $.fn.annotatr = function(opts) {
        $.annotatr.init(opts, this);
    };
    ...
    $.annotatr = {
        ...
        buildAnnotatorControls: function() {
            ...
            $('#annotatr_controls ul').append('<li><a href="#" id="annotatr_callout_toggle">' + this.options.label_annotations + '</a></li>');
        ...
        buildHotSpotControls: function() {
            $('#annotatr_controls ul').append('<li><a href="#" id="annotatr_hotspots_toggle">' + this.options.label_hotspots + '</a></li>');
        ...
        buildSpecificationWrapper: function() {
            $("body").append('<div id="annotatr_specification"><div id="annotatr_header">Notes</div></div>')
